...
df = pd.read_csv(os.environ.get("TALE_DATA_PATH", "data/math500/MATH-500.csv"))
print(f"Dataset length: {len(df)}")

tokenizer = AutoTokenizer.from_pretrained(os.environ.get("TALE_MODEL_PATH", "mistralai/Mistral-7B-Instruct-v0.3"))
model_base = AutoModelForCausalLM.from_pretrained(os.environ.get("TALE_MODEL_PATH", "mistralai/Mistral-7B-Instruct-v0.3"))

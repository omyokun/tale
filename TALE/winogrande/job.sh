...
apptainer exec --env "PYTHONUSERBASE=${MYENVS}/in-context-learning" --bind /tmpdir,/work --nv /work/conteneurs/calmip/custom_users/cuquantum_arrayfire.sif python /tmpdir/m24047nmmr/pruning/llama/winogrande/greedy.py
